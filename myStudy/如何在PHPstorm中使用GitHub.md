GitHub是一款非常棒的程序开发管理工具，可极其方便地做代码托管。但它的用途不止如此，可以用来搭建博客，能够绑定你自己的域名，免费、高效、不限流量，做一个个人页面绰绰有余；可以用于写文档神器，天然的版本管理，再不用担心修改乱掉了；可以用它来协作写书，不管多大的写作团队，都可以共同写一本书，作者们可以随时知道哪里出现了更改；还可以协作翻译，管理科研数据文档等等……
